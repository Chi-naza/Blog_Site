...
urlpatterns = [
    ...
    path('password-reset-complete/', auth_views.PasswordResetCompleteView.as_view(template_name = 'usersApp/password_reset_complete.html'), name = 'password_reset_complete'),
]
